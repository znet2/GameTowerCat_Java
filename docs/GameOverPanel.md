...
4. **วาดปุ่ม Restart**:
   ...
   - วาดปุ่มสีเขียวมุมโค้ง
   - วาดข้อความ "RESTART" สีขาวตรงกลางปุ่ม
...
- ปุ่ม Restart ขนาด 200x60 พิกเซล สีเขียว มุมโค้ง
...
3. **ง่ายต่อการใช้งาน**: ปุ่ม Restart ที่ชัดเจนและใช้งานง่าย
