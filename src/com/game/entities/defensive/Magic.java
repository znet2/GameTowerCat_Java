...
import com.game.entities.projectiles.MagicBall;
import com.game.utils.Constants;
import com.game.utils.MathUtils;
...
public class Magic extends GameObject implements Defensive, Collidable {
    ...
    public Magic(int gridColumn, int gridRow, int tileSize, Image magicImage, ArrayList<BaseEnemy> enemies) {
        ...
        this.bombImage = ImageLoader.loadImage(Constants.Paths.MAGIC_BOMB_IMAGE);
        if (this.bombImage == null) {
            this.bombImage = magicImage;
        }

        // Load magic ball images
        this.normalBallImage = ImageLoader.loadImage(Constants.Paths.NORMAL_MAGIC_BALL_IMAGE);

        this.superBallImage = ImageLoader.loadImage(Constants.Paths.SUPER_MAGIC_BALL_IMAGE);
    }
