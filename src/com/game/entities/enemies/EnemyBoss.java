...
import com.game.entities.projectiles.BossSkillBall;
...
public class EnemyBoss extends BaseEnemy {
    ...
    public EnemyBoss(Map gameMap, CoinManager coinManager) {
        ...
        this.idleImage = ImageLoader.loadImage(Constants.Paths.BOSS_IMAGE);
        this.flyImage = ImageLoader.loadImage(Constants.Paths.BOSS_FLY_IMAGE);
        this.attackImage = ImageLoader.loadImage(Constants.Paths.BOSS_ATTACK_IMAGE);
        this.skillImage = ImageLoader.loadImage(Constants.Paths.BOSS_SKILL_IMAGE);
        this.skillBallImage = ImageLoader.loadImage(Constants.Paths.BOSS_SKILL_BALL_IMAGE);
    }
