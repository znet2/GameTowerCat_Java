...
public class BossSkillBall {
    ...
    private Rectangle getUnitBounds(Defensive unit) {
        if (unit instanceof com.game.entities.defensive.Tank) {
            return ((com.game.entities.defensive.Tank) unit).getBounds();
        } else if (unit instanceof com.game.entities.defensive.Magic) {
            return ((com.game.entities.defensive.Magic) unit).getBounds();
        } else if (unit instanceof com.game.entities.defensive.Archer) {
            return ((com.game.entities.defensive.Archer) unit).getBounds();
        } else if (unit instanceof com.game.entities.defensive.House) {
            return ((com.game.entities.defensive.House) unit).getBounds();
        }
        return null;
    }
